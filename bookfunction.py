...
class BookFunction:
    ...
    def __initial_data(self):
        a_book1 = Book(isbn_no="ISBN1234", title="The Solar System", book_format="Hardcover", subject="Science", rental_price=15.00, copies=5)
        a_book2 = Book(isbn_no="ISBN9876", title="Types of Animal Species", book_format="Paperback", subject="Science", rental_price=10.00, copies=8)
        a_book3 = Book(isbn_no="ISBN1290", title="Second World War", book_format="Hardcover", subject="History", rental_price=12.50, copies=1)
